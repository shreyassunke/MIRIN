...
- **Motion:** plates settle onto the sleeve in 160ms ease-out-expo. Equipment pages track the finger, then settle in ~380ms ease-out-expo; reduced motion skips the slide. Under `prefers-reduced-motion`, plates appear in place and tilt is off.
