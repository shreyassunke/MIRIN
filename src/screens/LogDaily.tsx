...
/** Today's weight and macros, plus the ledger of what came before. */
  ...
  return (
    <div>
      <section className="mb-10" aria-labelledby="today-log">
        <h2 id="today-log" className="mb-4 text-[13px] font-medium text-muted">
      ...
      <section aria-labelledby="recent-log">
        <h2 id="recent-log" className="mb-2 text-[13px] font-medium text-muted">
          Recent
        </h2>
        {data === undefined ? (
